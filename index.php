              ...
              <div class="row">
                <div class="form-group">
                  <div class="col-lg-3 col-xs-12">
                    <label for="login" class="btn btn-default btn-sm" style="width:100%">
                      <span class="glyphicon glyphicon-user"></span> Login
                    </label>
                  </div>
                  <div class="col-lg-9 col-xs-12">
                    <input name="login" type="text" class="form-control" id="loginform-login" placeholder="Podaj Login" required></input>
                  </div>
                </div>
              </div><br/>
              <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-lg-9 col-xs-12">
                    <input name="mail" type="text" class="form-control" id="loginform-login" placeholder="Podaj e-mail" required></input>
                  </div>
                </div>
              </div><br/>
              <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-lg-9 col-xs-12">
                    <input name="pass1" type="password" class="form-control" id="loginform-login" placeholder="Podaj hasło" required></input>
                  </div>
                </div>
              </div><br/>
              <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-lg-9 col-xs-12">
                    <input name="pass2" type="password" class="form-control" id="loginform-login" placeholder="Powtórz hasło" required></input>
                  </div>
                </div>
              </div><br/>
